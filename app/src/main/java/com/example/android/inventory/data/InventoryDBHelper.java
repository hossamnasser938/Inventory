...
public class InventoryDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String SQL_CREATE_TABLE_PRODUCT = "CREATE TABLE" + Product.TABLE_NAME + "("
                ...
                + Product.COLUMN_PRODUCT_NAME + InventoryContract.DATA_TEXT + InventoryContract.CONSTRAINT_NOT_NULL + InventoryContract.CONSTRAINT_UNIQUE + ", "
    ...
    public static void insertRowIntoInventoryTable(SQLiteDatabase db){
